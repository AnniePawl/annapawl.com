...
export default function Embroidery(){
    return(
        <div className='bg-zinc-50 pb-5 md:pb-0 h-fit min-h-screen w-screen flex flex-col justify-center items-center pt-0'>
             <Link to="/">
        ...
        {/* Description */}
        <div className='pt-6 md:pt-2 pb-0 w-full px-10 md:px-0 max-w-3xl flex items-center justify-center'>
            <p className='text-center font-[500] text-xs md:text-base tracking-wider text-zinc-800'>🌛 Crafting the nights away is one of my favorite pastimes. Thanks for checking out my little sews 🧵 More crafts to come! 🧶 </p>
        </div>
